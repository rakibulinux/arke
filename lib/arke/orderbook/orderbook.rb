...
module Arke::Orderbook
  class Orderbook < Base
    ...
    def adjust_volume_simple(adjusted_volume_base, adjusted_volume_quote)
      bids_ratio = adjusted_volume_quote / volume_bids_quote
      asks_ratio = adjusted_volume_base / volume_asks_base

      asks = ::RBTree.new
      bids = ::RBTree.new
      adj_volume_bids_base = 0
      adj_volume_asks_base = 0
      adj_volume_bids_quote = 0
      adj_volume_asks_quote = 0
