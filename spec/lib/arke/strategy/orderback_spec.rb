  ...
  context "running both sides" do
    ...
    it "outputs a target orberbook" do
      expect(target_bids.to_hash).to eq(
        # +0.1359554e3 => 0.95982849262347e-2,
        # +0.1359652e3 => 0.527190829074743e-1,
        # +0.135975e3 => 0.1131269161072195e0,
        # +0.1359848e3 => 0.1727615249109062e0,
        # +0.1360044e3 => 0.11517941911481652e1,
