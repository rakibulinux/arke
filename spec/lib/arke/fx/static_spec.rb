  ...
  context "apply" do
    ...
    it "applies the rate to orderbook and prices points" do
      ...
      expect(fx_ob[:sell].to_hash).to eq(
        (1_402_573_826_086_956_521.to_d * 1e-16 * rate) => "0.6656597259005248e0".to_d,
        (1_402_688.to_d * 1e-4 * rate)                  => "0.28941727213066e-2".to_d,
        (1_402_789.to_d * 1e-4 * rate)                  => "0.28941727213066e-2".to_d,
        (140_289.to_d * 1e-3 * rate)                    => "0.2417267470176631e0".to_d,
        (1_402_977_264_909.to_d * 1e-10 * rate)         => "0.868251816391989e-1".to_d,
      )
