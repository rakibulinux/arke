...
RSpec.describe BalancesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new balance" do

        post :create, params: {balance: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(balance_url(Balance.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new balance" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the balance" do
        balance = Balance.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the balance" do
        balance = Balance.create! valid_attributes
